...
function getCommonAppearanceRulesText() {
  ...
  return [
    ...
    "GEM: a LARGE glowing hexagonal salt-crystal gem at the center of the chest, sized to about 30% of the width of the upper torso, cut in this character's own signature accent color with bright specular highlights — this exact gem must always be present and clearly visible, same shape on every sibling, only the color differs",
